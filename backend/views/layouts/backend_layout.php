...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="index.php" class="logo d-flex align-items-center">
            ...
            <span class="d-none d-lg-block">EP-Admin</span>
        </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="assn-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="<?= Url::to('index.php?r=site%2Fwk') ?>">
                        <i class="bi bi-circle"></i><span>吴魁</span>
                    </a>
                </li>
                <li>
                    <a href="<?= Url::to('index.php?r=site%2Flx') ?>">
                        <i class="bi bi-circle"></i><span>李想</span>
                    </a>
                </li>
