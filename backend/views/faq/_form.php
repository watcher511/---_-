    ...
    <div class="card">
        <div class="card-body">
            ...
            <?php if($to === 'create'): ?>
                ...
                <?= Html::beginForm('@web/index.php?r=faq/create','post',['enctype' => 'multipart/form-data']) ?>
            <?php else: ?>
                <h5 class="card-title"><b>回答/编辑提问</b></h5>
                <?= Html::beginForm('@web/index.php?r=faq/update' . '&id=' . $model->id,'post',['enctype' => 'multipart/form-data']) ?>
            <?php endif;?>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <label for="inputText" class="col-form-label">优先级（前6名将显示在FAQ中）</label>
