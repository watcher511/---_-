        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input class="form-control" name="source_twitter" value="<?=$model->source_twitter?>">
                </div>
                <div class="col-md-4">
                    <label for="inputText" class="col-form-label">新闻来源FaceBook</label>
                    <input class="form-control" name="source_facebook" value="<?=$model->source_facebook?>">
                </div>
                <div class="col-md-4">
                    <label for="inputText" class="col-form-label">新闻来源Instagram</label>
                    <input class="form-control" name="source_instagram" value="<?=$model->source_instagram?>">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-4">
